...
class Block(nn.Module):
    ...
    """
    def __init__(self, dim, drop_path: float = 0.0, kernel_size: int = 5, use_grn: bool = False, layer_scale_init_value: float = 1e-6):
        super().__init__()
...
class ConvNeXt3d(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000, 
                 depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], drop_path_rate=0., use_grn=False,
