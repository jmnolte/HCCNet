...
#SBATCH --job-name=diagnostics18                # job name
#SBATCH -e diagnostics.err                      # error file
#SBATCH --gres=gpu:1                            # number of gpus, 4
#SBATCH --mem=120gb                             # Job memory request
#SBATCH -o diagnostics18.out                    # output file
...
# diagnostics script for resnet18 using fault tolerant processing. Script returns occlusion sensitivity
