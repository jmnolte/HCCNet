...
#SBATCH --job-name=diagnostics34                # job name
#SBATCH -e diagnostics.err                      # error file
#SBATCH --gres=gpu:1                            # number of gpus, 4
#SBATCH --mem=120gb                             # Job memory request
#SBATCH -o diagnostics34.out                    # output file
...
# diagnostics script for resnet34 using fault tolerant processing. Script returns occlusion sensitivity
