...
#SBATCH --job-name=diagnostics50                # job name
#SBATCH -e diagnostics.err                      # error file
#SBATCH --gres=gpu:1                            # number of gpus, 4
#SBATCH --mem=120gb                             # Job memory request
#SBATCH -o diagnostics50.out                    # output file
...
# diagnostics script for resnet50 using fault tolerant processing. Script returns occlusion sensitivity
