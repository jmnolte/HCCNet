...
#SBATCH --job-name=diagnosticsEns               # job name
#SBATCH -e diagnostics.err                      # error file
#SBATCH --gres=gpu:1                            # number of gpus, 4
#SBATCH --mem=120gb                             # Job memory request
#SBATCH -o diagnosticsEns.out                   # output file
...
# diagnostics script for the ensemble using fault tolerant processing. Script returns occlusion sensitivity
