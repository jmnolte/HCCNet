...
#SBATCH -e resnet50.err                         # error file
#SBATCH --gres=gpu:4                            # number of gpus 4
#SBATCH --mem=120gb                             # Job memory request
#SBATCH -o resnet50.out                         # output file
...
# training script for resnet50 using fault tolerant training. Script returns updated set of model weights 
