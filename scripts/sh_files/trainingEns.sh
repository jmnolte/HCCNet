...
#SBATCH -c 8                                    # number of cores, 8
#SBATCH --job-name=ensemble                     # job name
#SBATCH -e ensemble.err                         # error file
#SBATCH --gres=gpu:1                            # number of gpus, 1
#SBATCH --mem=120gb                             # Job memory requeststarts, ends, and fails
#SBATCH -o ensemble.out                         # output file
...
# training script for the ensemble using fault tolerant training. Script returns updated set of model weights 
